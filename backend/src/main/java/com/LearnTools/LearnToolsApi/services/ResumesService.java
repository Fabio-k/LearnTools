...
public class ResumesService {
    ...
    public ResumesService(UserRepository userRepository, ResumeRepository resumeRepository, TagRepository tagRepository,
            ResumeTagRepository resumeTagRepository) {
    ...
    public Resume createResume(ResumesDTO resumesDTO, UserDetails userDetails) {
    ...
    public List<ResumesResponseDTO> getUserResumes(UserDetails userDetails) {
        List<Resume> userResumes = findUserResumes(userDetails);
